...
keymap("n", "<leader>la", "<cmd>lua vim.lsp.buf.code_action({apply = true})<cr>", { desc = "Code Action" })
...
keymap("n", "<leader>gc", function() require("tinygit").smartCommit() end, { desc = "Git Smart Commit" })
keymap("n", "<leader>gp", function() require("tinygit").push() end, { desc = "Git Push" })
